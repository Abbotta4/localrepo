...
LICENSE="GPL-2"
KEYWORDS=""
IUSE="+git X zsh-completion fish-completion emacs dmenu rofi importers elibc_Darwin"
...
RDEPEND="
	...
	rofi? ( x11-misc/rofi x11-misc/xdotool )
...
src_install() {
	...
	if use rofi && use dmenu || use rofi && ! use dmenu; then
